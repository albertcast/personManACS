...
public class Person {
	...
	public Person(String name, int age, String gender) {
		if(name.isBlank() || age < 0 || (gender != "Male" && gender != "Female"))
			throw new RuntimeException("Datos introducidos inv�lidos. Los datos deben ser: nombre no vac�o, edad positiva y g�nero Male o Female. Los datos introducidos son: Nombre - " + 
					name + " ,edad - " + age + " ,g�nero - " + gender);
		this.name = name;
		this.age = age;
		this.gender = gender;	
	}
